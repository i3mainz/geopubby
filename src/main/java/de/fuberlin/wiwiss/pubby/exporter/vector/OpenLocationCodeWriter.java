...
public class OpenLocationCodeWriter extends GeoModelWriter {

	public OpenLocationCodeWriter(String epsg) {
		super(epsg);
	}
	...
	public ExtendedIterator<Resource> write(Model model, HttpServletResponse response) throws IOException {
		...
		try {
			if (lat == null || lon == null) {
				...
				response.getWriter().write(OpenLocationCode.encode(lat, lon));	
				response.getWriter().close();
			}
