...
public class GeoHashWriter  extends GeoModelWriter {

	public GeoHashWriter(String epsg) {
		super(epsg);
	}
	...
	public ExtendedIterator<Resource> write(Model model, HttpServletResponse response) throws IOException {
		...
		try {
			if (lat == null || lon == null) {
				...
				response.getWriter().write(GeoHash.geoHashStringWithCharacterPrecision(lat, lon, 12));	
				response.getWriter().close();
			}
